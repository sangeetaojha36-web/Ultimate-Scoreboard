...
const JWT_SECRET = 'ultimate-scoreboard-jwt-secret-2024';

// Simple in-memory storage with pre-hashed password
let users = [
  {
    id: 1,
    username: 'sangeeta',
    email: 'sangeetaojha36@gmail.com',
    password: '$2a$10$P4nt3xnbpNRDNveVm8E.vec3JetRAR/CoKyP3NCkdNbO6fkUpdd3a',
...
app.get('/api/health', (req, res) => {
  res.json({ status: 'OK', message: 'Ultimate Scoreboard API' });
});
